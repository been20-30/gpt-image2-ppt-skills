...
- **2026-08-01 · Template cloning, distillation, and online gallery upgrade** — Unified template reuse and added multi-slide visual checks, old/new comparisons, and failure protection. All 22 historical templates now support the new workflow and will replace published versions only after a confirmed visual improvement. Current templates are also presented in SlideCraft Template Gallery with search, filters, real output previews, and copy-ready prompts for AI assistants.
